  ...
  <AuthenticatedLayout>
    <div class="max-w-3xl mx-auto space-y-6">
      ...
      <div class="flex items-center gap-4">
        ...
        <div>
          <h2 class="text-3xl font-bold text-a4pm-gray-900">Nova Receita</h2>
          <p class="mt-1 text-a4pm-gray-600">Adicione uma nova receita ao seu catálogo</p>
        </div>
      </div>
...
async function handleSubmit() {
  ...
  const result = await receitasStore.criarReceita(form.value)
